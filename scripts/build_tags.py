...
TOPIC_TAGS: dict[str, str] = {
    # Spiritual core — English OR Hindi
    'meditation':     'meditation OR ध्यान',
    'love':           'love OR प्रेम',
    'death':          'death OR मृत्यु',
    'god':            'god OR ईश्वर OR परमात्मा OR भगवान',
    'freedom':        'freedom OR स्वतंत्रता OR मुक्ति',
    'awareness':      'awareness OR witnessing OR साक्षी OR जागरूकता OR होश',
    'silence':        'silence OR मौन OR खामोशी',
    'truth':          'truth OR सत्य',
    'bliss':          'bliss OR ecstasy OR आनंद OR परमानंद',
    'ego':            'ego OR अहंकार',
    'mind':           'mind OR मन OR चित्त',
    'surrender':      'surrender OR समर्पण',
    'devotion':       'devotion OR भक्ति OR श्रद्धा',
    'creativity':     'creativity OR सृजन OR सर्जनात्मकता',
    'prayer':         'prayer OR प्रार्थना',
    'disciple':       'disciple OR seeker OR शिष्य OR साधक',
    'courage':        'courage OR साहस OR हिम्मत',
    'laughter':       'laughter OR humor OR हास्य OR हंसी',
    'anger':          'anger OR क्रोध OR गुस्सा',
    'fear':           'fear OR भय OR डर',
    'loneliness':     'loneliness OR aloneness OR एकाकीपन OR अकेलापन',
    'dreams':         'dream OR सपना OR स्वप्न',
    'energy':         'energy OR ऊर्जा OR शक्ति',
    'breath':         'breathing OR श्वास OR प्राण',
    'body':           'body OR शरीर OR देह',
    'nature':         'nature OR प्रकृति',
    'beauty':         'beauty OR सुंदर OR सौंदर्य',
    'transformation': 'transformation OR रूपांतरण OR परिवर्तन',
    'enlightenment':  'enlightenment OR बोध OR समाधि OR ज्ञान OR जागरण',
    'compassion':     'compassion OR करुणा OR दया',
    'trust':          'trust OR विश्वास OR श्रद्धा',
    # Society / outer world
    'society':        'society OR समाज',
    'religion':       'religion OR धर्म',
    'education':      'education OR शिक्षा',
    'politics':       'politics OR political OR राजनीति',
    'women':          'woman OR women OR स्त्री OR नारी OR महिला',
    'children':       'child OR children OR बच्चा OR बच्चे OR बालक',
    'science':        'science OR scientific OR विज्ञान',
    'art':            'art OR artistic OR कला',
    'relationship':   'relationship OR intimacy OR संबंध OR रिश्ता',
}
